...
// NOTE(bartlomieju):
// eagerly loading built-in formatters so they are included in the bundle
const FORMATTERS = {
    "checkstyle": require("../cli-engine/formatters/checkstyle"),
    "compact": require("../cli-engine/formatters/compact"),
    "html": require("../cli-engine/formatters/html"),
    "jslint-xml": require("../cli-engine/formatters/jslint-xml"),
    "json-with-metadata": require("../cli-engine/formatters/json-with-metadata"),
    "json": require("../cli-engine/formatters/json"),
    "junit": require("../cli-engine/formatters/junit"),
    "stylish": require("../cli-engine/formatters/stylish"),
    "tap": require("../cli-engine/formatters/tap"),
    "unix": require("../cli-engine/formatters/unix"),
    "visualstudio": require("../cli-engine/formatters/visualstudio"),
};
...
class FlatESLint {
    ...
    async loadFormatter(name = "stylish") {
        ...
        // NOTE(bartlomieju): currently only supporting built-in formatters
        ...
        // //     }
        // // }
        // const formatterPath = path.resolve(__dirname, "eslint", "lib", "cli-engine", "formatters", `${normalizedFormatName}.js`);
        // let formatter;

        const formatter = FORMATTERS[name];

        if (!formatter) {
            throw new Error("Only built-in formatters are currently supported");
        }
